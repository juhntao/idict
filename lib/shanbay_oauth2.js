...
ShanbayOauth.initPage = function(){
    ...
    window.OAuth = ShanbayOauth.fromConfig(ShanbayConf);
    return window.OAuth;
}

ShanbayOauth.fromConfig = function(shanbay_conf){
...
ShanbayOauth.prototype.authorize = function(callback){
    ...
    var authorize_url = authorize_url + "?response_type=token&client_id="+this.conf.client_id;
    console.log("in authorize", authorize_url);
...
ShanbayOauth.prototype.onAuthorize = function(tabId, changeInfo, tab){
    console.log('onAuthorize',tab.url);
